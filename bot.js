...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Desert Bot- Script By : MOhanad`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : MOhanad ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`Mazza Shop`,"http://twitch.tv/Death Shop")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            ...
            رابط سيرفر الدعم الفني : https://discord.gg/nGHeSg
            **`);
